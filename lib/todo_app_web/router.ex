defmodule TodoAppWeb.Router do
  ...
  scope "/", TodoAppWeb do
    ...
    live "/bars", BarLive.Index, :index
    live "/bars/new", BarLive.Index, :new
    live "/bars/:id/edit", BarLive.Index, :edit

    live "/bars/:id", BarLive.Show, :show
    live "/bars/:id/show/edit", BarLive.Show, :edit
